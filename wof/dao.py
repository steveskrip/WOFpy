...
class BaseDao(object):
    ...
    def get_series_by_sitecode_and_varcode(self, site_code, var_code):
        ...
        code combination.
        """
        raise NotImplementedError("get_series_by_sitecode_and_varcode Method not implemented.")
    ...
    def get_qualcontrollvls_by_ids(self, qual_control_lvl_id_arr):
        ...
        """
        raise NotImplementedError("get_qualcontrollvls_by_ids Method not implemented.")

    def get_offsettype_by_id(self, offset_type_id):
        """
        Returns a single OffsetType identified by the given id.
        """
        raise NotImplementedError("get_offsettype_by_id Method not implemented.")

    def get_offsettypes_by_ids(self, offset_type_id_arr):
        """
        Returns a list of OffsetTypes identified by the given id list.
        """
        raise NotImplementedError("get_offsettypes_by_ids Method not implemented.")

    def get_sites_by_box(self, west,south,east,north):
        """
        Returns a list of OffsetTypes identified by the given id list.
        """
        raise NotImplementedError("get_sites_by_box Method not implemented.")
