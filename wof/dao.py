...
msg = '{} Method not implemented by this service.'.format
...
class BaseDao(object):
    ...
    def get_series_by_sitecode_and_varcode(self, site_code, var_code):
        ...
        code combination.
        """
        raise NotImplementedError(msg('get_series_by_sitecode_and_varcode'))
