...
def startServer(conf='odm2_config_timeseries.cfg', openPort=8080):
    """
    Start wofpy application with builtin server.
    :param conf: Configuration file. Default: odm2_config_timeseries.cfg
    :param openPort: Open port for server. Default: 8080
    """
